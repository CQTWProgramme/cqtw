 ...
 */
-(void)SLTabBar:(SLTabBar *)tabBar didSelectViewController:(UIViewController *)viewController;

@end

@interface SLTabBar : UITabBarController

@property(nonatomic,assign) id<SLTabBarDelegate>SLTabBarDelegate;
