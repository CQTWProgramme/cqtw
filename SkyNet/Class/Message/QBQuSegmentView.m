...
-(void)setSubviewWith:(NSArray *)titleA{
    ...
    for (int i = 0; i < titleA.count; i++) {
        ...
        CGFloat btnW = SCREEN_WIDTH/titleA.count;
        NSString *title = titleA[i];
        UIFont *font = SLFont(16);
        ...
        [button setTitleColor:[UIColor hexStringToColor:@"5F98FC"] forState:UIControlStateSelected];
        button.tag = i;
...
//    CGFloat linewidth = SCREEN_WIDTH/2;
    CGFloat linewidth = SCREEN_WIDTH/_titleA.count - self.lineAdjust;
...
-(void)setSelectBtn:(LxButton *)selectBtn{
    ...
    [self setLineViewFrame:_selectBtn];
}
