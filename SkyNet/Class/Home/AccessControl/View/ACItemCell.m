...
+ (instancetype)cellWithTableView:(UITableView *)tableView{
    static NSString *reuseIdentity = @"ACItemCell";
    
    ACItemCell *cell = [tableView dequeueReusableCellWithIdentifier:reuseIdentity];
    
    if (cell == nil){
        cell = [[ACItemCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:reuseIdentity];
    }
    return cell;
}
