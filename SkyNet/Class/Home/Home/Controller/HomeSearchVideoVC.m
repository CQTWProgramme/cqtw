...
- (void)loadData {
                ...
                if (weakSelf.currPage > totalPage) {
                    ...
                    if (arr.count > 0) {
                        for (NSDictionary *dic1 in arr) {
                            SearchResultVideoModel *model = [SearchResultVideoModel mj_objectWithKeyValues:dic1];
                            [muArr addObject:model];
                        }
                    }
    ...
    [viewModel getBdcDataLikeWithType:@"2" gn:@"4" query:self.searchText currPage:self.currPage pageSize:self.pageSize];
}
