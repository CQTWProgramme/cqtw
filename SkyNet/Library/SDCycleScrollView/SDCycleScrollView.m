...
//    [cell.imageView sd_setImageWithURL:url placeholderImage:self.placeholderImage];
    ...
    [cell.imageView sd_setImageWithURL:url placeholderImage:self.placeholderImage completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, NSURL *imageURL) {
        if (image) {
            [cell.imageView setContentMode:UIViewContentModeScaleAspectFit | UIViewContentModeTop | UIViewContentModeBottom | UIViewContentModeLeft | UIViewContentModeRight];
        }
